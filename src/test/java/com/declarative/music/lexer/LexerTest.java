...
class LexerTest
{
    ...
    void shouldHandleLambdaDefinition() throws IOException
    {
        // given
        final var code = """
            let fun = with(MidiNote a) -> MidiNote {
                return (C, 4) q;
            };
            """;
        final var lexer = new LexerImpl(new StringReader(code));
        ...
        assertThat(tokens).containsExactlyElementsOf(List.of(
            ...
            new Token(TokenType.T_IDENTIFIER, new Position(0, 15), "MidiNote"),
            ...
            new Token(TokenType.T_IDENTIFIER, new Position(0, 26), "MidiNote"),
