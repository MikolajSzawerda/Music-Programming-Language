...
public class OperationRegistry
{
    ...
    public <T, U, R> void register(Class<T> leftType, Class<U> rightType, BiFunction<T, U, R> operation, Class<R> returnType)
    {
    ...
    public Variant<?> apply(String operation, Variant<?> left, Variant<?> right)
    {
        ...
        throw new IllegalStateException("Unsupported types for operation: " + operation);
    }
