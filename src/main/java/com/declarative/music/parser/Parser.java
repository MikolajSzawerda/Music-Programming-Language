...
import com.declarative.music.parser.exception.UnknownProductionException;
import com.declarative.music.parser.exception.UnsupportedBinaryOperator;
...
public class Parser
{
    ...
    private Expression parseArrayExpressionWithCheckedFirst() throws ParsingException, IOException
    {
        ...
        if (nextToken.type() == T_OPERATOR && nextToken.value() == OperatorEnum.O_LIST_COMPR)
        {
            ...
            return new ListComprehension(expression,
                new VariableReference((String) tempVariable.value(), tempVariable.position()),
                range,
                startPosition);
        }
    ...
    private Expression tryParseLeaf() throws ParsingException, IOException
    {
        ...
        {
            consumeToken();
            var array = parseArrayExpressionWithCheckedFirst();
            return array;
        }
